...
class TestARMInstruction(TestCase):
    ...
    def test_conditional(self):
        # add r3, pc, r3
        arm = ARMInstruction("03 30 8f e0", 0, Instruction.HEX_STR)
    ...
    def test_registers_written_ldr(self):
        # ldr	r5, [pc, #44]
        arm1 = ARMInstruction("2c 50 9f e5", 0, Instruction.HEX_STR)
        r1 = arm1.registers_written()
        self.assertTrue(5 in r1)
        # ldr	r6, [pc, #72]
        arm2 = ARMInstruction("48 60 9f e5", 0, Instruction.HEX_STR)
